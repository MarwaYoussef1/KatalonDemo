...
myKeywords.setName('marwa')

String name = myKeywords.getName()
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'connet')
